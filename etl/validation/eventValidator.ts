...
export class EventValidator {
  ...
  private setupSchemas() {
    ...
    this.schemas.set('player.created', z.object({
    ...
    this.schemas.set('player.updated', z.object({
      playerId: z.string().uuid(),
    ...
    this.schemas.set('player.level_up', z.object({
      playerId: z.string().uuid(),
    ...
    this.schemas.set('player.inventory_changed', z.object({
      playerId: z.string().uuid(),
    ...
    this.schemas.set('player.logged_in', z.object({
      playerId: z.string().uuid(),
    ...
    this.schemas.set('player.logged_out', z.object({
      playerId: z.string().uuid(),
      sessionId: z.string().uuid(),
    ...
    // World event schemas
    this.schemas.set('world.region_created', z.object({
      regionId: z.string(),
      name: z.string(),
      serverNode: z.string(),
      bounds: z.object({
    ...
    this.schemas.set('world.region_status_changed', z.object({
      regionId: z.string(),
    ...
    this.schemas.set('world.weather_changed', z.object({
      regionId: z.string(),
    ...
    this.schemas.set('world.event_started', z.object({
    ...
    this.schemas.set('world.resource_spawned', z.object({
    ...
    this.schemas.set('combat.attack', z.object({
    ...
    this.schemas.set('combat.spell_cast', z.object({
      combatId: z.string().uuid(),
    ...
    this.schemas.set('chat.whisper', z.object({
    ...
    this.schemas.set('system.maintenance_start', z.object({
      reason: z.string(),
    ...
    this.schemas.set('system.server_status', z.object({
      serverNode: z.string(),
    ...
    this.schemas.set('trade.initiated', z.object({
    ...
    this.schemas.set('trade.completed', z.object({
      tradeId: z.string().uuid(),
    ...
    // Guild event schemas
    this.schemas.set('guild.created', z.object({
    ...
    this.schemas.set('guild.member_joined', z.object({
      guildId: z.string().uuid(),
      playerId: z.string().uuid(),
    ...
    logger.info(`Event validator initialized with ${this.schemas.size} schemas`);
  }

  async validate(eventType: string, data: any): Promise<ValidationResult> {
    this.validationStats.total++;

    const typeStats = this.validationStats.byType.get(eventType) || { passed: 0, failed: 0 };
  ...
  async validateBatch(events: Array<{ eventType: string; data: any }>): Promise<BatchValidationResult> {
